...
func _toggle_inventory() -> void:
	if _dialogue_box.is_open() or _random_encounter_panel.is_open() or _foraging_panel.is_open() or _fishing_panel.is_open() or _talent_panel.visible or _professions_panel.is_open() or _quest_log_panel.is_open() or _legend_panel.is_open():
		return
...
func _toggle_talents() -> void:
	if _dialogue_box.is_open() or _random_encounter_panel.is_open() or _foraging_panel.is_open() or _fishing_panel.is_open() or _inventory_panel.visible or _professions_panel.is_open() or _quest_log_panel.is_open() or _legend_panel.is_open():
		return
...
func _toggle_professions() -> void:
	if _dialogue_box.is_open() or _random_encounter_panel.is_open() or _foraging_panel.is_open() or _fishing_panel.is_open() or _talent_panel.visible or _inventory_panel.visible or _quest_log_panel.is_open() or _legend_panel.is_open():
		return
...
func _toggle_quest_log() -> void:
	if _dialogue_box.is_open() or _random_encounter_panel.is_open() or _foraging_panel.is_open() or _fishing_panel.is_open() or _talent_panel.visible or _inventory_panel.visible or _professions_panel.is_open() or _legend_panel.is_open():
		return
...
func _process(_delta: float) -> void:
	...
	if _inventory_panel.visible or _dialogue_box.is_open() or _random_encounter_panel.is_open() or _foraging_panel.is_open() or _fishing_panel.is_open() or _talent_panel.visible or _professions_panel.is_open() or _quest_log_panel.is_open() or _legend_panel.is_open():
...
func _unhandled_input(event: InputEvent) -> void:
	...
	if event.is_action_pressed("toggle_interactable_legend"):
		_toggle_legend()
		return
	if _inventory_panel.visible or _random_encounter_panel.is_open() or _foraging_panel.is_open() or _fishing_panel.is_open() or _talent_panel.visible or _professions_panel.is_open() or _quest_log_panel.is_open() or _legend_panel.is_open():
		return
